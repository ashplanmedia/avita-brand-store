...
class Interceptor extends \Ves\Blog\Controller\Adminhtml\Post\Save implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'uploadImage');
        if (!$pluginInfo) {
            return parent::uploadImage($fieldId);
        } else {
            return $this->___callPlugins('uploadImage', func_get_args(), $pluginInfo);
        }
    }
