...
class Interceptor extends \Ves\BaseWidget\Block\Widget\Singleproduct implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getColorSwatchesHtml');
        if (!$pluginInfo) {
            return parent::getColorSwatchesHtml($_product);
        } else {
            return $this->___callPlugins('getColorSwatchesHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDataFilterHelper');
        if (!$pluginInfo) {
            return parent::getDataFilterHelper();
        } else {
            return $this->___callPlugins('getDataFilterHelper', func_get_args(), $pluginInfo);
        }
    }
     ...
     * {@inheritdoc}
     */
    public function getSingleLink($product, $params = array())
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSingleLink');
        if (!$pluginInfo) {
            return parent::getSingleLink($product, $params);
        } else {
            return $this->___callPlugins('getSingleLink', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function subString($text, $length = 100, $replacer = '...', $is_striped = true)
    {
        ...
        if (!$pluginInfo) {
            return parent::subString($text, $length, $replacer, $is_striped);
        } else {
