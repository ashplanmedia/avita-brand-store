...
class Interceptor extends \Ves\Productlist\Block\Widget\Tab implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsByCondition');
        if (!$pluginInfo) {
            return parent::getProductsByCondition();
        } else {
            return $this->___callPlugins('getProductsByCondition', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductHtml');
        if (!$pluginInfo) {
            return parent::getProductHtml($data);
        } else {
            return $this->___callPlugins('getProductHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCmsBlockModel()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCmsBlockModel();
        } else {
            return $this->___callPlugins('getCmsBlockModel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductsBySource');
        if (!$pluginInfo) {
            return parent::getProductsBySource($source_key);
        } else {
            return $this->___callPlugins('getProductsBySource', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAjaxUrl');
        if (!$pluginInfo) {
            return parent::getAjaxUrl();
        } else {
            return $this->___callPlugins('getAjaxUrl', func_get_args(), $pluginInfo);
        }
    }
