...
class Interceptor extends \Ves\Productlist\Controller\Widget\Adminhtml\Widget\BuildWidget implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isBase64Encoded');
        if (!$pluginInfo) {
            return parent::isBase64Encoded($data);
        } else {
            return $this->___callPlugins('isBase64Encoded', func_get_args(), $pluginInfo);
        }
    }
